...
public abstract class AbstractIndexMetadataInjector implements IMetadataInjector, IBusable {

    public static final String IPLUG_OPERATOR = "IPLUG_OPERATOR";

    private Logger LOG = Logger.getLogger(AbstractIndexMetadataInjector.class.getName());
    ...
    public class IPlugOperator implements Serializable {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((_partners == null) ? 0 : _partners.hashCode());
            return result;
        }
        ...
        private AbstractIndexMetadataInjector getOuterType() {
            return AbstractIndexMetadataInjector.this;
        }
    }
    ...
    public class Partner implements Serializable {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((_providers == null) ? 0 : _providers.hashCode());
            result = prime * result + ((_shortName == null) ? 0 : _shortName.hashCode());
            return result;
        }
    ...
    public void injectMetaDatas(Metadata metadata) {
        try {
            ...
            IPlugOperator newPlugOperator = createIPlugOperator(partnerSet, providerSet);
    ...
    private IPlugOperator createIPlugOperator(Set<String> partnerSet, Set<String> providerSet) {
