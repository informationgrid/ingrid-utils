...
public abstract class AbstractPlugOperatorMetadataInjector implements IMetadataInjector, IBusable {

    public static final String IPLUG_OPERATOR = "IPLUG_OPERATOR";

    private Logger LOG = Logger.getLogger(AbstractPlugOperatorMetadataInjector.class.getName());
