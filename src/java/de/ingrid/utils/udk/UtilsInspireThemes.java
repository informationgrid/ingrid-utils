...
public class UtilsInspireThemes {
	...
	static {
		...
		inspireThemes_de.put(106, "Flurst�cke/Grundst�cke (Katasterparzellen)");
		inspireThemes_de.put(107, "Verkehrsnetze");
		inspireThemes_de.put(108, "Gew�ssernetz");
		inspireThemes_de.put(109, "Schutzgebiete");
		inspireThemes_de.put(201, "H�he");
		...
		inspireThemes_de.put(302, "Geb�ude");
		...
		inspireThemes_de.put(307, "Umwelt�berwachung");
		...
		inspireThemes_de.put(310, "Verteilung der Bev�lkerung � Demografie");
		...
		inspireThemes_de.put(313, "Atmosph�rische Bedingungen");
		...
		inspireThemes_de.put(318, "Lebensr�ume und Biotope");
		inspireThemes_de.put(319, "Verteilung der Arten");
		inspireThemes_de.put(320, "Energiequellen");
		inspireThemes_de.put(321, "Mineralische Bodensch�tze");
	...
	static {
		...
		termToThemeIds_de.put("flurst�ck", new Integer[]{106});
		termToThemeIds_de.put("grundst�ck", new Integer[]{106});
		termToThemeIds_de.put("katasterparzelle", new Integer[]{106});
		termToThemeIds_de.put("verkehrsnetz", new Integer[]{107});
		termToThemeIds_de.put("gew�ssernetz", new Integer[]{108});
		termToThemeIds_de.put("schutzgebiet", new Integer[]{109, 311});
		termToThemeIds_de.put("h�he", new Integer[]{201});
		...
		termToThemeIds_de.put("geb�ude", new Integer[]{302});
		...
		termToThemeIds_de.put("umwelt�berwachung", new Integer[]{307});
		...
		termToThemeIds_de.put("verteilung der bev�lkerung", new Integer[]{310});
		...
		termToThemeIds_de.put("atmosph�rische bedingung", new Integer[]{313});
